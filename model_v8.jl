...
CSV com medias dia-a-dia (30 linhas) das 5 variaveis (proc, ocioso, spill,
fila_out, custo) + custo acumulado, para cada politica em colunas.
"""
function gerar_csv_dia_a_dia(mes::String, series::Dict)
    ...
    @printf("  CSV dia-a-dia salvo: v8_%s_dia_a_dia.csv\n", mes)
end
